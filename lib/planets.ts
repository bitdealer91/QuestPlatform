...
export const PLANETS: Planet[] = [
  ...
  { id: 4, title: 'Week 4', img: '/assets/4.png', x: 84, y: 60 },
  { id: 5, title: 'Week 5', img: '/assets/5.png', x: 54, y: 78 },
  { id: 6, title: 'Week 6', img: '/assets/6.png', x: 22, y: 66 },
  { id: 7, title: 'Week 7', img: '/assets/7.png', x: 44, y: 46 },
  { id: 8, title: 'Week 8', img: '/assets/8.png', x: 64, y: 48 },
];
