...
export const STARS_1155_ADDRESS = (process.env.NEXT_PUBLIC_STARS_1155_ADDRESS || '') as `0x${string}` | '';
...
export function hasStarsContractConfigured(): boolean {
  return typeof STARS_1155_ADDRESS === 'string' && STARS_1155_ADDRESS.length > 0;
}
...
// Stars1155 write ABI (mint with amount)
export const STARS_ABI = [
  { "type": "function", "name": "balanceOf", "stateMutability": "view", "inputs": [ { "name": "account", "type": "address" }, { "name": "id", "type": "uint256" } ], "outputs": [ { "name": "", "type": "uint256" } ] },
  { "type": "function", "name": "mintWithSig", "stateMutability": "nonpayable", "inputs": [ { "name": "to", "type": "address" }, { "name": "id", "type": "uint256" }, { "name": "amount", "type": "uint256" }, { "name": "nonce", "type": "uint256" }, { "name": "deadline", "type": "uint256" }, { "name": "signature", "type": "bytes" } ], "outputs": [] }
] as const;
