 ...
 */
export function OdysseyScenery() {
	...
	return (
		<>
			...
			{/* 7 — 74:221 */}
			<IslandChrome frame={f[7]} z={Z.island7}>
			...
			{/* 5 — 68:200 */}
			<IslandChrome frame={f[5]} z={Z.island5}>
				<div
					className="absolute flex items-center justify-center overflow-visible"
			...
			{/* 8 — 91:4 */}
			<IslandChrome frame={f[8]} z={Z.island8}>
			...
			{/* 4 — 74:222 */}
			<IslandChrome frame={f[4]} z={Z.island4}>
			...
			<IslandChrome frame={f[3]} z={Z.island3}>
			...
			{/* 2 — 68:201 */}
			<IslandChrome frame={f[2]} z={Z.island2}>
			...
			{/* 1 — 41:6: glow → base → пунктир (как в Figma, поверх базы). */}
			<div
			...
			>
				<div className="pointer-events-none absolute" style={{ left: 73.54, top: 69.15, width: 316.161, height: 159.808 }}>
					<div className="relative h-full w-full">
						<img
				...
				<div
					className="absolute overflow-visible"
					style={{ left: 8.53, top: 20.67, width: 472.821, height: 246.569, filter: GLOW['1base'] }}
				>
					<div className="relative h-full w-full">
